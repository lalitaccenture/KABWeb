...
<div className="w-1/5 p-4 bg-white shadow-2xl rounded-lg flex flex-col" style={{ marginTop: '-6.5%',marginLeft:'-1%' }}>
  ...
  <div className="mt-6">
    ...
    <button className="flex items-center gap-2 p-2 bg-gray-100 text-gray-700 rounded-lg w-full" onClick={()=>router.push("/prediction")}>
                ...
                {showTooltip && (
                  ...
                  >
                    ...
                    <ul className="mt-3 text-[13px] leading-[1.5] list-disc pl-3" style={{ marginLeft: '-9px' }}>
                     ...
                     <li> <span>Correlation values are derived from the 2020 Keep America Beautiful (KAB) survey and may change as more data is collected. 
                     Correlation does not imply causation, it indicates a statistical association and should not be interpreted as direct cause-and-effect evidence.</span></li>
                    </ul>
